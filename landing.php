...
<head>
    ...
    <style>
        /* Override external CSS - Force header to top */
        html, body {
            margin: 0 !important;
            padding: 0 !important;
        }
    ...
    <div class="hero-section">
        <div class="container hero-content">
            ...
            <div style="margin-top: 2rem;">
                <a href="#portals" class="btn btn-outline" style="background: rgba(255,255,255,0.1); border: 2px solid rgba(255,255,255,0.3); color: white;">
                    Get Started
                </a>
            </div>
        </div>
